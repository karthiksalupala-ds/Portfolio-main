...
import stackImage from '../assets/about/Hero Image.png.png';
...
const PythonIcon = () => (
  <div className="flex flex-col items-center gap-2">
    <svg className="w-16 h-16 md:w-20 md:h-20" viewBox="0 0 128 128">
      ...
      <rect x="18" y="18" width="92" height="92" rx="26" fill="url(#pythonGrad)" />
      <text x="64" y="76" textAnchor="middle" fill="white" fontSize="34" fontWeight="800" fontFamily="Arial, sans-serif">Py</text>
    </svg>
...
const AICoreIcon = () => (
  <div className="flex flex-col items-center gap-2">
    <svg className="w-16 h-16 md:w-20 md:h-20" viewBox="0 0 128 128">
      <circle cx="64" cy="64" r="42" fill="#111827" />
      <path d="M42 68c0-12 10-22 22-22h10v10H64c-6.6 0-12 5.4-12 12s5.4 12 12 12h10v10H64c-12 0-22-10-22-22z" fill="#ff2a2a" />
      <path d="M86 60c0 12-10 22-22 22H54V72h10c6.6 0 12-5.4 12-12s-5.4-12-12-12H54V38h10c12 0 22 10 22 22z" fill="#f59e0b" opacity="0.95" />
    </svg>
    <span className="text-xs font-bold text-white/70 uppercase tracking-wider">AI / LLM</span>
  </div>
);
          ...
          <div data-aos="drop-bounce" className="relative flex justify-center w-full">
            ...
            <div className="bg-gray-900 w-full max-w-[280px] rounded-2xl p-3 shadow-[0_20px_40px_rgba(0,0,0,0.4)] relative z-20 transform -rotate-3 hover:rotate-0 transition-transform duration-500">
              ...
              <div className="w-full aspect-[3/4] overflow-hidden rounded-xl bg-gray-800 border-2 border-transparent">
                <img 
                  src={stackImage} 
                  alt="Karthik Salupala — AI Engineer & Full Stack Developer" 
