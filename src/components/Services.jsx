...
import { experienceContent } from '../data/portfolioData';
    ...
    >
      <div className="max-w-6xl mx-auto relative md:h-[1350px]">
        ...
        <div className="flex flex-col gap-8 md:gap-12 items-center md:block relative z-10 w-full pt-4 md:pt-0 pb-12 md:pb-0">
          ...
          {experienceContent.cards.map((card, index) => {
            const positions = [
              ...
              "md:absolute md:top-[760px] md:right-[8%] lg:right-[15%] rotate-1 md:rotate-3",
            ];
          ...
          {/* Hand-drawn end text */}
          {experienceContent.endText && (
            <div 
              data-aos="fade-in" 
              data-aos-delay="600"
              className="hidden md:block absolute top-[1180px] left-[60%] font-['Caveat',cursive] text-3xl text-gray-600 rotate-6"
            >
              {experienceContent.endText}
            </div>
          )}
