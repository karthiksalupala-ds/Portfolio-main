...
import heroVideo from '../assets/hero video/Hero Talking Video.mp4.mp4';
import { heroContent, personalInfo, socialLinks } from '../data/portfolioData';

const EmailIcon = () => (
  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 8l9 6 9-6m-18 8V8l9 6 9-6v8" />
  </svg>
);
